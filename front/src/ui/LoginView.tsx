  ...
  return (
    <div className="flex min-h-[calc(100vh-140px)]">
      ...
      <div className="flex w-full lg:w-1/2 items-center justify-center bg-[#f7f7f7] dark:bg-slate-950 px-4 sm:px-6 py-8">
        <div className="w-full max-w-md bg-white dark:bg-slate-900 rounded-2xl shadow-md dark:shadow-slate-950/20 p-6 sm:p-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 dark:text-white text-center">Iniciar sesión</h2>
              ...
              <Form className="mt-6 space-y-5">
                ...
                <div>
                  ...
                  <div className="relative mt-1">
                    ...
                    <Field
                      ...
                      className="w-full rounded-xl border border-gray-200 bg-white text-gray-900 dark:bg-slate-950 dark:text-gray-100 dark:border-slate-700 placeholder-gray-500 dark:placeholder-slate-400 py-2.5 pl-10 pr-4 text-sm focus:border-[#e76f51] focus:outline-none focus:ring-2 focus:ring-[#f4a261]/40"
                    />
                  </div>
                ...
                <div>
                  ...
                  <div className="relative mt-1">
                    ...
                    <Field type={showPassword ? 'text' : 'password'} name="password" placeholder="••••••••" maxLength={20} className="w-full rounded-xl border border-gray-200 bg-white text-gray-900 dark:bg-slate-950 dark:text-gray-100 dark:border-slate-700 py-2.5 pl-10 pr-10 text-sm focus:border-[#e76f51] focus:outline-none focus:ring-2 focus:ring-[#f4a261]/40" />
                  </div>
