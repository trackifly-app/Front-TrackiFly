              ...
              <Form className="mt-6 space-y-5">
                ...
                <div>
                  ...
                  <div className="relative mt-1">
                    ...
                    <Field type={showPassword ? 'text' : 'password'} name="password" placeholder="••••••••" maxLength={20} className="w-full rounded-xl border border-border bg-surface-muted text-foreground py-2.5 pl-10 pr-10 text-sm focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/30" />
                  </div>
                ...
                {/* Button */}
                <button type="submit" disabled={!!errors.email || !!errors.password} className="w-full rounded-xl bg-primary py-3 text-sm font-semibold text-primary-foreground transition hover:bg-primary-hover disabled:bg-surface-muted disabled:text-muted">
                  Ingresar
                </button>
              </Form>
            )}
