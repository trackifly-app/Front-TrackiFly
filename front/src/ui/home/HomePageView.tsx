...
const HomePageView = () => {
  return (
    <div className="bg-background w-full overflow-x-hidden">
      <div className="bg-surface w-full px-4 sm:px-6 md:px-10 lg:px-20 xl:px-32 py-10 md:py-14 lg:py-1 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-1 items-start">
