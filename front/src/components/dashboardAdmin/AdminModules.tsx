        ...
        {modules.map((module) => {
          ...
          return (
            <button
              key={module.title}
              type="button"
              className="group rounded-2xl border border-border bg-surface-muted p-5 text-left transition-all duration-300 hover:-translate-y-1 hover:border-primary/30 hover:bg-primary/10"
            >
...
export const adminModulesData = [
  {
    title: "Empresas",
    description:
      "Gestiona el registro, consulta y administración general de empresas.",
    icon: Building2,
  },
  {
