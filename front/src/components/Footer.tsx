    ...
    <footer className="bg-[#1e2530] text-gray-300">
      <div className="max-w-7xl mx-auto px-8 py-12 grid grid-cols-2 md:grid-cols-4 gap-10">
        ...
        <div className="flex flex-col gap-4 col-span-2 md:col-span-1">
          ...
          <p className="text-sm">08000-333-8356</p>
          <p className="text-sm">trackifly@gmail.com.ar</p>
          ...
          <div className="flex flex-col gap-2 mt-2">
            ...
            <div className="flex">
              <input
                ...
                className="flex-1 bg-[#2a3241] text-sm text-gray-300 placeholder-gray-500 px-3 py-2 rounded-l outline-none border border-[#3a4251]"
              />
              <button className="bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded-r text-sm font-medium transition-colors">
                Ir
              </button>
            </div>
          </div>
