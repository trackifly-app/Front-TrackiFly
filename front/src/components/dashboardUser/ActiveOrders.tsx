          ...
          orders.map((order) => (
            ...
            >
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-4">
                ...
                <span className="w-fit bg-orange-500 text-white text-sm font-medium px-3 py-1 rounded-full">
                  {order.status}
                </span>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                ...
                <div>
                  ...
                  <p className="text-slate-800 font-medium">{order.estimatedDelivery}</p>
                </div>
              </div>
            </div>
          ))
